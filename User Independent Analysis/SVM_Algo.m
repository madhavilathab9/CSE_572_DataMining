...
for i=1:10
	...
	svm_model =  fitcsvm(Total_Train_data_svm,result,'standardize',true,'KernelFunction','gaussian','BoxConstraint',1,'OutlierFraction',0.10);
...
csvwrite('Performance_SVM.csv', matrix1);
